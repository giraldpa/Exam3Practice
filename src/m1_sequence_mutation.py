...
def run_test_zero_changer():
    ...
    # ------------------------------------------------------------------
    # Test 2:
    test2 = ([0, 9, 0, 8], [7, 10, 0, 14, 34, 0], [9, 8, 4], [4, 0, 4])
    expected2 = ([1, 9, 2, 8], [7, 10, 3, 14, 34, 4], [9, 8, 4], [4, 5, 4])
    zero_changer(test2)
    print()
    print('Test 1:')
    ...
    # Test 3:
    test3 = ([], [90, 0, 0, 40, 9, 0], [], [1, 19, 0])
    expected3 = ([], [90, 1, 2, 40, 9, 3], [], [1, 19, 4])
    zero_changer(test3)
    print()
    print('Test 1:')
